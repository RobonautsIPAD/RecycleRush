...
- (void)viewDidLoad
{
    ...
    headerView.backgroundColor = [UIColor colorWithRed:(200/255.0) green:(000/255.0) blue:(000/255.0) alpha:(100.0/100.0)];
	...
	UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(100, 0, 200, 50)];
