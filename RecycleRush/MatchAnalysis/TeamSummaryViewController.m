    ...
    //NSLog(@"%@", stats);
        if (indexPath.row == 0) {
            ...
            label10.text = [NSString stringWithFormat:@"%1.1f", [[[stats objectForKey:@"autonCansFromStep"] objectForKey:@"average"] floatValue]];
                ...
                label5.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label6 = (UILabel *)[cell viewWithTag:60];
                label6.text = @"Black Robot";
                label6.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label7 = (UILabel *)[cell viewWithTag:70];
                label7.text = @"Black HP";
                label7.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label8 = (UILabel *)[cell viewWithTag:80];
                label8.text = @"";
                label8.font = [UIFont boldSystemFontOfSize:14.0];
                ...
                UILabel *label3 = (UILabel *)[cell viewWithTag:30];
                label3.text = [NSString stringWithFormat:@"%1.0f", [[[stats objectForKey:@"wowlistRobot"] objectForKey:@"total"] floatValue]];
                UILabel *label4 = (UILabel *)[cell viewWithTag:40];
                label4.text = [NSString stringWithFormat:@"%1.0f", [[[stats objectForKey:@"wowlistHP"] objectForKey:@"total"] floatValue]];
                UILabel *label6 = (UILabel *)[cell viewWithTag:60];
                label6.text = [NSString stringWithFormat:@"%1.0f", [[[stats objectForKey:@"blacklistRobot"] objectForKey:@"total"] floatValue]];
                UILabel *label7 = (UILabel *)[cell viewWithTag:70];
                label7.text = [NSString stringWithFormat:@"%1.0f", [[[stats objectForKey:@"blacklistHP"] objectForKey:@"total"] floatValue]];
                UILabel *label10 = (UILabel *)[cell viewWithTag:90];
                label10.text = @"";
                label10.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label11 = (UILabel *)[cell viewWithTag:20];
                label11.text = @"";
                label11.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label16 = (UILabel *)[cell viewWithTag:100];
                label16.text = @"";
                label16.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label17 = (UILabel *)[cell viewWithTag:50];
                label17.text = @"";
                label17.font = [UIFont boldSystemFontOfSize:14.0];
                UILabel *label18 = (UILabel *)[cell viewWithTag:80];
                label18.text = @"";
                label18.font = [UIFont boldSystemFontOfSize:14.0];
            }
    }
