...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    red1Label.text = [MatchAccessors getTeamNumber:scoreList forAllianceString:@"Red 1" forAllianceDictionary:allianceDictionary];

    UILabel *red2Label = (UILabel *)[cell viewWithTag:30];
    red2Label.text = [MatchAccessors getTeamNumber:scoreList forAllianceString:@"Red 2" forAllianceDictionary:allianceDictionary];

	UILabel *red3Label = (UILabel *)[cell viewWithTag:40];
    red3Label.text = [MatchAccessors getTeamNumber:scoreList forAllianceString:@"Red 3" forAllianceDictionary:allianceDictionary];

	UILabel *blue1Label = (UILabel *)[cell viewWithTag:50];
    blue1Label.text = [MatchAccessors getTeamNumber:scoreList forAllianceString:@"Blue 1" forAllianceDictionary:allianceDictionary];

	UILabel *blue2Label = (UILabel *)[cell viewWithTag:60];
    blue2Label.text = [MatchAccessors getTeamNumber:scoreList forAllianceString:@"Blue 2" forAllianceDictionary:allianceDictionary];

	UILabel *blue3Label = (UILabel *)[cell viewWithTag:70];
    blue3Label.text = [MatchAccessors getTeamNumber:scoreList forAllianceString:@"Blue 3" forAllianceDictionary:allianceDictionary];
