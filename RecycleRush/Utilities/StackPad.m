...
#pragma mark - StackPad Implementation

@implementation StackPad

@synthesize targetTextInput;

#pragma mark - Shared StackPad method

+ (StackPad *)defaultStackPad {
    static StackPad *defaultStackPad = nil;
    static dispatch_once_t onceToken;

    
    dispatch_once(&onceToken, ^{
        defaultStackPad = [[[NSBundle mainBundle] loadNibNamed:@"StackPad" owner:self options:nil] objectAtIndex:0];
    });
    
    return defaultStackPad;
}
